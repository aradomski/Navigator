...
public class ForResultActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book = new Book();
        book.setAuthor(ForResultActivity.class.getSimpleName());
        book.setPublishTime(2012);
        book.setBookName("Result");
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("ForResultActivity{");
